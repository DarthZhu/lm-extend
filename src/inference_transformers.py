...
from transformers import AutoTokenizer, Qwen2AudioForConditionalGeneration, AutoProcessor
...
def main():
    ...
    # )
    processor = AutoProcessor.from_pretrained("data/models/Qwen2-Audio-7B-Instruct")
    model = Qwen2AudioForConditionalGeneration.from_pretrained("data/models/Qwen2-Audio-7B-Instruct").to("cuda")
    ...
    for batch in batch_texts:
        ...
        generate_ids = model.generate(inputs.input_ids, max_length=8096, do_sample=False)
